...
Ever since I joined GitHub, I pushed **{{ COMMITS }}** commits, opened **{{ ISSUES }}** issues, submitted **{{ PULL_REQUESTS }}** pull requests, received **[{{ STARS }}](https://github.com/agmmnn?tab=repositories&sort=stargazers&type=source)** stars across **[{{ REPOSITORIES }}](https://github.com/agmmnn?tab=repositories&q=&type=public&language=&sort=)** personal projects, and contributed to **[{{ REPOSITORIES_CONTRIBUTED_TO }}](https://github.com/pulls?q=is%3Apr+author%3Aagmmnn)** public repositories.
...
- And when I'm not blazing trails in the coding cosmos (🤷‍♂️), I'm on an adrenaline fuelled journey of _pentesting_ and _reverse engineering_, unravelling the enigmatic depths of software systems.
