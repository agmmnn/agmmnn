...
It's Gökçe. Ever since I joined GitHub, I pushed **1306** commits, opened **14** issues, submitted **20** pull requests, received **[6124 stars](https://github.com/agmmnn?tab=repositories&sort=stargazers&type=source)** across **[67 personal](https://github.com/agmmnn?tab=repositories&q=&type=public&language=&sort=)** projects, and contributed to **[3 public](https://github.com/pulls?q=author%3Aagmmnn)** repositories.
...
- [Quickly Test Your Webhooks with Cloudflare Tunnel](https://agmmnn.dev/posts/quickly-test-local-webhooks/)
- [SSL Pinning Bypass For Android Using Frida](https://agmmnn.dev/posts/ssl-pinning-bypass-with-frida/)
- [Installing Burp Suite Certificate in an Android Emulator](https://agmmnn.dev/posts/burp-suite-android/)
<!-- BLOG-POST-LIST:END -->
